...
class Messages:
    ...
    @staticmethod
    def outreach_service_info_prompt() -> str:
        """Запрос информации об услугах."""
        return (
            "📋 <b>Информация об услугах</b>\n\n"
            "Опишите ваши услуги и цены — AI будет использовать эту информацию "
            "при общении с лидами.\n\n"
            "<i>Пример:</i>\n"
            "<code>Бесплатный аудит карточки на картах (показываем что улучшить)\n"
            "Разовая оптимизация: 10-15 тыс\n"
            "Ежемесячное продвижение: от 20 тыс/мес\n"
            "Тестовый период: бесплатный аудит + рекомендации</code>\n\n"
            "Или нажмите «Пропустить» — AI будет предлагать обсудить детали на звонке."
        )
