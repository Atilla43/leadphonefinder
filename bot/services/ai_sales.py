...
- Когда клиент согласен — спроси "когда удобно созвониться?", не навязывай конкретное время
...
Клиент: "нет времени" → "10 мин буквально, когда удобно?"
Клиент: "есть подрядчик" → "а что именно делают? просто часто бывает что дополняем"
Клиент: "расскажите" → "давайте лучше по телефону, нагляднее. когда удобно созвониться?"
Клиент: "отправьте на почту" → "могу скинуть, но по телефону быстрее — 10 мин буквально"
Клиент: "перезвоните" → "когда удобно?"
