...
const features = [
  {
    ...
    title: "AI-диалоги",
    description:
      "Бот ведёт естественные разговоры, обрабатывает возражения, извлекает контакты рефералов. Распознаёт голосовые сообщения и отвечает на них текстом.",
  },
  {
    icon: BarChart3,
    title: "Аналитика в реальном времени",
    description:
      "Воронка продаж, конверсии, динамика по дням. Мгновенные обновления — видите каждый ответ сразу на дашборде.",
  },
  {
    icon: RefreshCw,
    title: "Мульти-аккаунт",
    description:
      "Пул Telegram-аккаунтов с автоматической ротацией. 30 сообщений/день на аккаунт, человекоподобные задержки.",
  },
  {
    icon: Target,
    title: "Автоматический скраппинг",
    description:
      "Поиск компаний по картам и каталогам. Находит директоров, ИНН, юридическую форму. Дедупликация базы.",
  },
];
